		...
		<section class="container-wrapper px-6">
			<hlm-tabs [tab]="_activeTab()" class="w-full pb-5">
				<hlm-tabs-list
					...
					class="bg-background border-2 dark:[&>a]:bg-background [&>a]:text-muted-foreground [&>a]:data-[state=active]:text-primary [&>a]:hover:text-primary dark:[&>a]:data-[state=active]:bg-background [&>a]:cursor-pointer [&>a]:data-[state=active]:shadow-none dark:[&>a]:data-[state=active]:border-none"
				>
