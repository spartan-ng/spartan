...
@Component({
	selector: 'spartan-area-chart-axes',
	changeDetection: ChangeDetectionStrategy.OnPush,
	host: { class: 'block w-full' },
	imports: [SpnAreaChart, SpnXAxis, SpnYAxis, SpnArea, SpnCartesianGrid, SpnTooltip, SpnTooltipContentDef],
	template: `
...
export class AreaChartAxes {
	protected readonly margin = { top: 12, right: 12, bottom: 30, left: 40 };
