...
@Component({
	selector: 'spartan-area-chart-stacked-expand',
	changeDetection: ChangeDetectionStrategy.OnPush,
	host: { class: 'block w-full' },
	imports: [SpnAreaChart, SpnXAxis, SpnArea, SpnCartesianGrid, SpnTooltip, SpnTooltipContentDef],
	template: `
		<spn-area-chart class="block h-[250px] w-full" [data]="data" [margin]="margin" stackOffset="expand">
...
export class AreaChartStackedExpand {
