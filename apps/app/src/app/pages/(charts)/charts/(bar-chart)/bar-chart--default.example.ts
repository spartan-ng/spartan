...
@Component({
	selector: 'spartan-bar-chart-default',
	changeDetection: ChangeDetectionStrategy.OnPush,
	host: { class: 'block w-full' },
	imports: [SpnBarChart, SpnXAxis, SpnBar, SpnCartesianGrid],
	template: `
		<spn-bar-chart class="block h-[250px] w-full" [data]="data" [margin]="margin">
			...
			/>
			<spn-bar dataKey="desktop" name="Desktop" fill="var(--chart-1)" radius="8" />
		</spn-bar-chart>
	`,
})
export class BarChartDefault {
	protected readonly margin = { top: 12, right: 12, bottom: 0, left: 12 };
