...
@Component({
	selector: 'spartan-bar-chart-label',
	...
	template: `
		<spn-bar-chart class="block h-[250px] w-full" [data]="data" [margin]="margin">
			...
			/>
			<spn-bar dataKey="desktop" name="Desktop" fill="var(--chart-1)" radius="8" [label]="label" />
			<spn-tooltip>
...
export class BarChartLabel {
	protected readonly margin = { top: 20, right: 12, bottom: 30, left: 12 };
	protected readonly label: BarLabelConfig = { offset: 12, fontSize: 12, fill: 'var(--foreground)' };
