...
@Component({
	selector: 'spartan-line-chart-interactive',
...
export class LineChartInteractive {
	...
	// shadcn colours desktop with --chart-1 and mobile with --chart-2.
	protected readonly lineColor = computed(() =>
		this.interactiveKey() === 'desktop' ? 'var(--chart-1)' : 'var(--chart-2)',
	);
	protected readonly margin = { top: 12, right: 12, bottom: 30, left: 12 };
	protected readonly yDomain = [0, 600] as [number, number];
