...
@Component({
	selector: 'spartan-pie-chart-label',
...
export class PieChartLabel {
	...
	// shadcn's pie label shows each segment's value with a connector line to the slice.
	...
	protected readonly labelLine = true;
