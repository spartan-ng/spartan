...
@Component({
	selector: 'spartan-radar-chart-grid-circle-fill',
	...
	template: `
		<div class="relative mx-auto block aspect-square h-[250px] w-[250px] max-w-full">
			<spn-radar-chart
				...
				[margin]="margin"
			>
				<spn-polar-grid gridType="circle" stroke="var(--border)" fill="var(--chart-1)" fillOpacity="0.2" />
				<spn-radar dataKey="desktop" name="Desktop" fill="var(--chart-1)" stroke="var(--chart-1)" fillOpacity="0.5" />
				<spn-tooltip>
...
export class RadarChartGridCircleFill {
