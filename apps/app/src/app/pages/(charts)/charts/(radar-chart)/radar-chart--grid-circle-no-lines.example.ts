...
@Component({
	selector: 'spartan-radar-chart-grid-circle-no-lines',
	...
	template: `
		<div class="relative mx-auto block aspect-square h-[250px] w-[250px] max-w-full">
			<spn-radar-chart
				...
				[margin]="margin"
			>
				<spn-polar-grid gridType="circle" stroke="var(--border)" radialLines="false" />
				<spn-radar
					dataKey="desktop"
					name="Desktop"
					fill="var(--chart-1)"
...
export class RadarChartGridCircleNoLines {
