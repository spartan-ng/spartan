...
import { SpnRadar, SpnRadarChart, SpnTooltip, SpnTooltipContentDef } from '@spartan-ng/charts';

@Component({
	selector: 'spartan-radar-chart-grid-none',
	changeDetection: ChangeDetectionStrategy.OnPush,
	host: { class: 'block w-full' },
	imports: [SpnRadarChart, SpnRadar, SpnTooltip, SpnTooltipContentDef],
	template: `
...
export class RadarChartGridNone {
