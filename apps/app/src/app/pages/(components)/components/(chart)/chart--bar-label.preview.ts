...
export class ChartBarLabelPreview {
		...
		series: [
			{
				...
				label: { show: true, position: 'top', color: resolveCssVar('--muted-foreground'), fontSize: 12 },
			},
			{
				name: 'mobile',
				type: 'bar',
