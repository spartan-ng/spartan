...
type StepDatum = { month: string; desktop: number };

const chartData: StepDatum[] = [
...
export class ChartLineStepPreview {
	...
	public readonly xAccessor: NumericAccessor<StepDatum> = (_d: StepDatum, i: number) => i;
	public readonly yAccessor: NumericAccessor<StepDatum> = (d: StepDatum) => d.desktop;
	public readonly colorAccessor = () => 'var(--chart-1)';
	public readonly curveTypeStep = CurveType.Step;
	public readonly tickFormat = (_: number | Date, i: number) => monthLabels[i] ?? '';

	public readonly crosshairTemplate = (d: StepDatum) => {
