...
type LineDatum = { month: string; desktop: number; mobile: number };
...
export class ChartLinePreview {
	...
	public readonly yAccessors: NumericAccessor<LineDatum>[] = [(d: LineDatum) => d.desktop, (d: LineDatum) => d.mobile];
