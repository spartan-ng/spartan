...
@Component({
	selector: 'spartan-chart-tooltip-default-preview',
	imports: [
		HlmCardImports,
		HlmChartImports,
		VisStackedBarModule,
	...
	template: `
		<hlm-card class="w-full">
			<hlm-card-header>
				<h3 hlmCardTitle>Tooltip - Default</h3>
				<p hlmCardDescription>Tooltip with default formatter</p>
			</hlm-card-header>
			<hlm-card-content>
				@if (isBrowser) {
...
export class ChartTooltipDefaultPreview {
