...
import { ChartAreaIconsPreview } from './chart--area-icons.preview';
...
import { ChartLineLinearPreview } from './chart--line-linear.preview';
...
import { ChartPieStackedPreview } from './chart--pie-stacked.preview';
import { ChartPiePreview } from './chart--pie.preview';
import { ChartScatterPreview } from './chart--scatter.preview';
import { ChartTooltipAdvancedPreview } from './chart--tooltip-advanced.preview';
import { ChartTooltipDefaultPreview } from './chart--tooltip-default.preview';
import { ChartTooltipIconsPreview } from './chart--tooltip-icons.preview';
import { ChartPreview, defaultImports, defaultSkeleton } from './chart.preview';

export const routeMeta: RouteMeta = {
	data: { breadcrumb: 'Chart', api: 'chart' },
	meta: metaWith('spartan/ui - Chart', 'Beautiful charts built with Unovis.'),
...
@Component({
	...
	imports: [
		...
		ChartPiePreview,
		ChartAreaIconsPreview,
		ChartLineLinearPreview,
		ChartPieStackedPreview,
		ChartScatterPreview,
		ChartTooltipDefaultPreview,
		ChartTooltipIconsPreview,
	...
	template: `
		<section spartanMainSection>
			<spartan-section-intro
				name="Chart"
				lead="Beautiful charts built with Unovis. Copy and paste into your apps."
				showThemeToggle
			/>
			...
			<p class="${hlmP}">
				An area chart using
				<code class="${hlmCode}">vis-area</code>
				with gradient fill.
			</p>
			<spartan-tabs firstTab="Preview" secondTab="Code">
				<div spartanCodePreview firstTab>
			...
			<p class="${hlmP}">
				...
				<code class="${hlmCode}">vis-donut</code>
				with inner radius.
			</p>
			<spartan-tabs firstTab="Preview" secondTab="Code">
				<div spartanCodePreview firstTab>
			...
			<p class="${hlmP}">
				...
				<code class="${hlmCode}">vis-stacked-bar</code>
				with stacked series.
			</p>
			<spartan-tabs firstTab="Preview" secondTab="Code">
				<div spartanCodePreview firstTab>
			...
			<p class="${hlmP}">
				...
				<code class="${hlmCode}">curveType: 'step'</code>
				.
			</p>
			<spartan-tabs firstTab="Preview" secondTab="Code">
				<div spartanCodePreview firstTab>
			...
			<h3 id="line-linear" spartanH4>Line Chart - Linear</h3>
			<p class="${hlmP}">
				A line chart with a linear curve using
				<code class="${hlmCode}">CurveType.Linear</code>
				.
			</p>
			<spartan-tabs firstTab="Preview" secondTab="Code">
				<div spartanCodePreview firstTab>
					<spartan-chart-line-linear-preview />
				</div>
				<spartan-code secondTab [code]="_lineLinearCode()" />
			</spartan-tabs>

			<h3 id="area-icons" spartanH4>Area Chart - Icons</h3>
			<p class="${hlmP}">
				An area chart with icon indicators using
				<code class="${hlmCode}">vis-area</code>
				.
			</p>
			<spartan-tabs firstTab="Preview" secondTab="Code">
				<div spartanCodePreview firstTab>
					<spartan-chart-area-icons-preview />
				</div>
				<spartan-code secondTab [code]="_areaIconsCode()" />
			</spartan-tabs>

			<h3 id="scatter" spartanH4>Scatter Chart</h3>
			<p class="${hlmP}">
				A scatter chart using
				<code class="${hlmCode}">vis-scatter</code>
				with color-coded points.
			</p>
			<spartan-tabs firstTab="Preview" secondTab="Code">
				<div spartanCodePreview firstTab>
					<spartan-chart-scatter-preview />
				</div>
				<spartan-code secondTab [code]="_scatterCode()" />
			</spartan-tabs>

			<h3 id="pie-stacked" spartanH4>Pie Chart - Stacked</h3>
			<p class="${hlmP}">
				A stacked pie chart using multiple
				<code class="${hlmCode}">vis-donut</code>
				overlays.
			</p>
			<spartan-tabs firstTab="Preview" secondTab="Code">
				<div spartanCodePreview firstTab>
					<spartan-chart-pie-stacked-preview />
				</div>
				<spartan-code secondTab [code]="_pieStackedCode()" />
			</spartan-tabs>

			<h3 id="tooltip-default" spartanH4>Tooltip - Default</h3>
			<p class="${hlmP}">
				A stacked bar chart with default tooltip using
				<code class="${hlmCode}">vis-crosshair</code>
				.
			</p>
			<spartan-tabs firstTab="Preview" secondTab="Code">
				<div spartanCodePreview firstTab>
					<spartan-chart-tooltip-default-preview />
				</div>
				<spartan-code secondTab [code]="_tooltipDefaultCode()" />
			</spartan-tabs>

			<h3 id="tooltip-icons" spartanH4>Tooltip - Icons</h3>
			<p class="${hlmP}">
				A stacked bar chart with icon indicators using
				<code class="${hlmCode}">vis-crosshair</code>
				.
			</p>
			<spartan-tabs firstTab="Preview" secondTab="Code">
				<div spartanCodePreview firstTab>
					<spartan-chart-tooltip-icons-preview />
				</div>
				<spartan-code secondTab [code]="_tooltipIconsCode()" />
			</spartan-tabs>

			<h3 id="tooltip-advanced" spartanH4>Tooltip - Advanced</h3>
			<p class="${hlmP}">
				A custom tooltip using
				<code class="${hlmCode}">vis-crosshair</code>
				template with totals.
			</p>
			<spartan-tabs firstTab="Preview" secondTab="Code">
				<div spartanCodePreview firstTab>
...
export default class ChartPage {
	...
	protected readonly _lineLinearCode = computed(() => this._snippets()['lineLinear']);
	protected readonly _areaIconsCode = computed(() => this._snippets()['areaIcons']);
	protected readonly _pieStackedCode = computed(() => this._snippets()['pieStacked']);
	protected readonly _scatterCode = computed(() => this._snippets()['scatter']);
	protected readonly _tooltipDefaultCode = computed(() => this._snippets()['tooltipDefault']);
	protected readonly _tooltipIconsCode = computed(() => this._snippets()['tooltipIcons']);
