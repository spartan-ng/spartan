...
@Component({
	selector: 'spartan-collapsible-accordion-animation-example',
	imports: [HlmCollapsibleImports, HlmButtonImports, NgIcon],
	providers: [provideIcons({ lucideChevronRight })],
	template: `
		<hlm-collapsible class="group/collapsible flex w-[350px] flex-col gap-2">
			...
			<hlm-collapsible-content
				class="overflow-hidden transition-[height] duration-200 ease-out data-[state=closed]:h-0 data-[state=open]:h-(--brn-collapsible-content-height)"
			>
...
export class CollapsibleAccordionAnimationExample {}
