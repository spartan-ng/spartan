...
import { DatePickerYearMonthExample } from '@spartan-ng/app/app/pages/(components)/components/(date-picker)/date-picker--month-year.example';
...
@Component({
	...
	template: `
		<section spartanMainSection>
			...
			<h3 id="date-year-month-picker" spartanH4>Month Year Picker</h3>
			<spartan-tabs firstTab="Preview" secondTab="Code">
				<div spartanCodePreview firstTab>
					<spartan-date-year-month-picker />
				</div>
				<spartan-code secondTab [code]="_yearMonthCode()" />
			</spartan-tabs>
...
export default class CardPage {
	...
	protected readonly _yearMonthCode = computed(() => this._snippets()['yearMonth']);
