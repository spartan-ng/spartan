...
import {
	datePickerFormMultipleCode,
	DatePickerFormMultipleExampleComponent,
} from './date-picker--form-multiple.example';
...
import { datePickerMultipleCode, DatePickerMultipleExampleComponent } from './date-picker--multiple.example';
...
@Component({
	...
	template: `
		<section spartanMainSection>
			...
			<h3 id="examples__default" class="${hlmH4} mb-2 mt-6">Form Multi Selection</h3>
			<p class="${hlmP} mb-6">
