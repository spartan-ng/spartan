...
@Component({
	...
	template: `
		<fieldset hlmFieldSet>
			<div hlmFieldGroup>
				<div hlmField>
					<label hlmFieldLabel for="field-select-department--trigger">Department</label>
					<brn-select id="field-select-department" class="inline-block" placeholder="Choose a department">
