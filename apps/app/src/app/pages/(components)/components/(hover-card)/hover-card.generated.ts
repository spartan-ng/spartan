...
Instead, edit the `(hover-card).preview.ts` file or the generator itself.
*/
export const defaultCode = `
import { Component } from '@angular/core';import { NgIcon, provideIcons } from '@ng-icons/core';import { lucideCalendar } from '@ng-icons/lucide';import { BrnHoverCardModule } from '@spartan-ng/brain/hover-card';import { HlmAvatarModule } from '@spartan-ng/helm/avatar';import { HlmButtonDirective } from '@spartan-ng/helm/button';import { HlmHoverCardModule } from '@spartan-ng/helm/hover-card';import { HlmIconDirective } from '@spartan-ng/helm/icon';@Component({
