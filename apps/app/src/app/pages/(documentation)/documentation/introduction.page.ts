	...
	template: `
		<section spartanMainSection>
			...
			<p class="${hlmP}">
				...
				allows you to build next-level, full-stack applications with AnalogJs. It provides an opinionated stack with a
				single command and a set of accessible UI primitives.
			</p>
