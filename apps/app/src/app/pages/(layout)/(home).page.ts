...
import { ZeropsLogoComponent } from '@spartan-ng/app/app/pages/(layout)/(home)/components/zerops-logo.component';
		...
		<section class="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
			<div class="${container} max-w-[64rem]">
				...
				<div class="flex flex-wrap justify-center gap-4">
					...
					>
						Star on GitHub
						@if (_githubRepoService.githubStarsCount()) {
							<span class="flex items-center gap-1 text-sm">
								{{ _githubRepoService.githubStarsCount() }}
...
export default class HomePageComponent {
	protected readonly _githubRepoService = inject(GithubRepoService);
