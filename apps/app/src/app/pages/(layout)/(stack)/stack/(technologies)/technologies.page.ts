...
import { ArchitectureDiagramAnalog } from './components/architecture-diagram-analog';
import { ArchitectureDiagramAngular } from './components/architecture-diagram-angular';
import { ArchitectureDiagramDrizzle } from './components/architecture-diagram-drizzle';
import { ArchitectureDiagramNx } from './components/architecture-diagram-nx';
import { ArchitectureDiagramSupabase } from './components/architecture-diagram-supabase';
import { ArchitectureDiagramTrpc } from './components/architecture-diagram-trpc';
