...
import { ArchitectureDiagramAnalogComponent } from '@spartan-ng/app/app/pages/(layout)/(stack)/stack/(technologies)/components/architecture-diagram-analog.component';
import { ArchitectureDiagramAngularComponent } from '@spartan-ng/app/app/pages/(layout)/(stack)/stack/(technologies)/components/architecture-diagram-angular.component';
import { ArchitectureDiagramDrizzleComponent } from '@spartan-ng/app/app/pages/(layout)/(stack)/stack/(technologies)/components/architecture-diagram-drizzle.component';
import { ArchitectureDiagramNxComponent } from '@spartan-ng/app/app/pages/(layout)/(stack)/stack/(technologies)/components/architecture-diagram-nx.component';
import { ArchitectureDiagramSupabaseComponent } from '@spartan-ng/app/app/pages/(layout)/(stack)/stack/(technologies)/components/architecture-diagram-supabase.component';
import { ArchitectureDiagramTrpcComponent } from '@spartan-ng/app/app/pages/(layout)/(stack)/stack/(technologies)/components/architecture-diagram-trpc.component';
