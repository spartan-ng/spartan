...
import { DashboardCardSection } from '../../(examples)/examples/dashboard/components/card-section';
import { DashboardTableSection } from '../../(examples)/examples/dashboard/components/table-section';
