...
export class BrnSelectContentComponent<T> implements AfterContentInit {
	...
	protected readonly _scrollUpBtn = contentChild(BrnSelectScrollUpDirective);
	protected readonly _scrollDownBtn = contentChild(BrnSelectScrollDownDirective);
	private readonly _options = contentChildren(BrnSelectOptionDirective, { descendants: true });

	/** @internal */
	public keyManager: FocusKeyManager<BrnSelectOptionDirective<T>> | null = null;
	...
	ngAfterContentInit(): void {
		this.keyManager = new FocusKeyManager(this._options())
			.withHomeAndEnd()
