...
export class BrnSelectValueComponent<T> {
	...
	protected readonly _customValueTemplate = contentChild(BrnSelectValueDirective, { descendants: true });
	protected readonly _customPlaceholderTemplate = contentChild(BrnSelectPlaceholderDirective, { descendants: true });
