	...
	implements ControlValueAccessor, DoCheck, ExposesSide, ExposesState, BrnFormFieldControl
{
	...
	protected readonly _selectLabel = contentChild(BrnLabelDirective, { descendants: false });

	/** Overlay pane containing the options. */
	protected readonly _selectContent = contentChild.required(BrnSelectContentComponent);
