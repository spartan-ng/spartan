...
describe('hlmBaseGenerator', () => {
	...
	it('should generate files correctly for a single lib', async () => {
		const options = {
			primitiveName: 'input',
