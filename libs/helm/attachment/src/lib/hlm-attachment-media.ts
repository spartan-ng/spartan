...
const attachmentMediaVariants = cva(
	"spartan-attachment-media group-data-[state=error]/attachment:bg-destructive/10 group-data-[state=error]/attachment:text-destructive relative flex aspect-square shrink-0 items-center justify-center overflow-hidden group-data-[orientation=vertical]/attachment:w-full group-data-[size=sm]/attachment:w-8 group-data-[size=xs]/attachment:w-7 group-data-[orientation=vertical]/attachment:*:data-[slot=spinner]:size-6! [&_ng-icon]:pointer-events-none [&_ng-icon:not([class*='size-'])]:size-4 group-data-[orientation=vertical]/attachment:[&_ng-icon:not([class*='size-'])]:size-6 group-data-[size=xs]/attachment:[&_ng-icon:not([class*='size-'])]:size-3.5",
	{
		variants: {
			variant: {
