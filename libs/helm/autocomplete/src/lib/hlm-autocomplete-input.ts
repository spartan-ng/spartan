...
@Component({
	...
	imports: [HlmInputGroupImports, NgIcon, HlmIcon, BrnAutocompleteAnchor, BrnAutocompleteClear, BrnAutocompleteInput],
		...
		<hlm-input-group brnAutocompleteAnchor class="w-auto">
			...
			@if (showSearch()) {
				<hlm-input-group-addon>
					<ng-icon hlmIcon name="lucideSearch" [class.opacity-50]="autocompleteInput.disabled()" />
				</hlm-input-group-addon>
			}
