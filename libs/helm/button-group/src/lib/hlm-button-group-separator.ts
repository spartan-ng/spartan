...
export class HlmButtonGroupSeparator {
	...
	protected readonly _computedClass = computed(() =>
		hlm(
			'bg-input relative !m-0 inline-flex shrink-0 self-stretch data-[orientation=horizontal]:h-px data-[orientation=vertical]:h-auto data-[orientation=horizontal]:w-full data-[orientation=vertical]:w-px',
			this.userClass(),
		),
	);
}
