...
@Component({
	...
	imports: [HlmIconImports, BrnPopoverImports, HlmPopoverImports, HlmCalendarMulti, HlmFieldControlDescribedBy],
	providers: [
...
export class HlmDatePickerMulti<T> implements ControlValueAccessor, DoCheck {
