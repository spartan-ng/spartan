...
@Component({
	...
	providers: [provideIcons({ lucideCalendar, lucideX }), provideHlmDatePickerTrigger(HlmYearMonthInput)],
...
export class HlmYearMonthInput<T> implements HlmDatePickerTriggerBase {
