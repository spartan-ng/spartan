...
const markerVariants = cva(
	"spartan-marker group/marker [a]:hover:text-foreground relative flex min-h-4 w-full items-center text-left text-sm [&_ng-icon:not([class*='size-'])]:size-4 [a]:underline [a]:underline-offset-3",
	{
		variants: {
			variant: {
