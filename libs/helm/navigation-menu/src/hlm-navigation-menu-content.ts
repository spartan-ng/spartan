...
export class HlmNavigationMenuContent {
	...
	protected readonly _computedClass = computed(() =>
		hlm(
			'data-[motion^=from-]:animate-in data-[motion^=to-]:animate-out data-[motion^=from-]:fade-in data-[motion^=to-]:fade-out left-0 top-0 w-full p-2 pr-2.5 md:w-auto',
			...
			'bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=open]:fade-in-0 data-[state=closed]:fade-out-0 **:data-[slot=navigation-menu-link]:focus:ring-0 **:data-[slot=navigation-menu-link]:focus:outline-none top-full overflow-hidden rounded-md border shadow !duration-200 data-[orientation=vertical]:mx-1.5 data-[orientation=horizontal]:mt-1.5',
			this.userClass(),
		),
	);
}
