...
export class HlmNavigationMenuTrigger {
	constructor() {
		classes(
			() =>
				'spartan-navigation-menu-trigger group/navigation-menu-trigger inline-flex h-9 w-max cursor-pointer items-center justify-center outline-none disabled:pointer-events-none disabled:cursor-not-allowed',
		);
	}
}
