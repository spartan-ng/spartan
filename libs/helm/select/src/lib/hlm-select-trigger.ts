...
@Component({
	...
	imports: [NgIcon, HlmIcon, BrnSelectTrigger, BrnFieldControlDescribedBy],
	...
	template: `
		...
		>
			<ng-content />
			<ng-icon hlmIcon name="lucideChevronDown" class="text-muted-foreground pointer-events-none text-base" />
		</button>
	`,
})
